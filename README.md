...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fe815a9934bf90015be4a3c
...
To start editing your site, you can use the Sanity interface at https://san-gats1-815a9.sanity.studio/.
...
Generated at `2020-12-27T05:06:49.871Z` by Stackbit version `0.3.41`.